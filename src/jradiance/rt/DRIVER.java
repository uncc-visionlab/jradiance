...
//public abstract class DRIVER {				/* driver functions */
    abstract void close() throws IOException;			/* close device */


    abstract void clear(int a, int b) throws IOException;			/* clear device */


    abstract void paintr(COLOR col, int xmin, int ymin, int xmax, int ymax) throws IOException;			/* paint rectangle */


    abstract int getcur(int[] a, int[] b) throws IOException;			/* get cursor position */


    abstract void comout(char[] a) throws IOException;			/* command line output */


    abstract void comin(char[] a, char[] b) throws IOException;			/* command line input */


    abstract void flush() throws IOException;			/* flush output */

    public double pixaspect;			/* pixel aspect ratio */

    public int xsiz, ysiz;			/* device size */

    public int inpready;				/* input ready on device */
//}
					/* magic numbers for verification */

    public static final int COM_SENDM = 0x6f37;
    public static final int COM_RECVM = 0x51da;
    /* stream commands */
    public static final int COM_CLEAR = 0;
    public static final int COM_PAINTR = 1;
    public static final int COM_GETCUR = 2;
    public static final int COM_COMOUT = 3;
    public static final int COM_COMIN = 4;
    public static final int COM_FLUSH = 5;
    public static final int NREQUESTS = 6;	/* number of valid requests */


    public static abstract class DEVICE {			/* interactive device */

        public String name;				/* device name */

        public String descrip;				/* description */

        public abstract DRIVER init(String name, String id);  /* initialize device */
    }
//devtable[];			/* supported devices */
//extern char  dev_default[];		/* default device name */
    public static final char MB1 = '\n';		/* mouse button 1 */

    public static final char MB2 = ('\r');		/* mouse button 2 */

    public static final char MB3 = (' ');		/* mouse button 3 */

    public static final char ABORT = ('C' - '@');	/* abort key */
