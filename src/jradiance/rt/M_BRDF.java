...
public static class BRDFDAT {
	OBJREC  mp;		/* material pointer */
	RAY  pr;		/* intersected ray */
	DATARRAY[]  dp;		/* data array for PDATA, MDATA or TDATA */
	COLOR  mcolor = new COLOR();		/* material (or pattern) color */
	COLOR  rdiff = new COLOR();		/* diffuse reflection */
	COLOR  tdiff = new COLOR();		/* diffuse transmission */
...
public static class BRDF extends OBJECT_STRUCTURE {
    @Override
    public int octree_function(Object... obj) {
        throw new UnsupportedOperationException("Not supported yet.");
    }    
}
public static class BRDF2 extends OBJECT_STRUCTURE {
    @Override
    public int octree_function(Object... obj) {
        throw new UnsupportedOperationException("Not supported yet.");
    }    
