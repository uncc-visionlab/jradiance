...
import jradiance.rt.SOURCE.VSMATERIAL;

/**
 *
 * @author arwillis
 */
public class M_DIRECT extends OBJECT_STRUCTURE {
/*
...
//
public static class DIRECT1_VS extends VSMATERIAL {
    DIRECT1_VS() {
        nproj = 1;
    }
    @Override
...
public static class DIRECT2_VS extends VSMATERIAL {
    DIRECT2_VS() {
        nproj = 2;
    }
    @Override
