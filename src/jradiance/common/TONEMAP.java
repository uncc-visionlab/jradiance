...
///****    Error Return Values    ****/
//
public static final int TM_E_OK=		0;		/* normal return status */
...
//
public static final int	TM_BRTSCALE=	256;		/* brightness scale factor (integer) */
//
...
public static double tmLuminance(double li) {
    return Math.exp((li)*(1./TM_BRTSCALE));
}
